...
from agents import GreenAgent, RandomYellowAgent, RandomRedAgent
    ...
    for step in range(steps):
        ...
        for agent in model.agents:
            if isinstance(agent, Waste) and agent.pos is not None:
                ...
                color = 'green' if isinstance(agent, GreenAgent) else 'yellow' if isinstance(agent, RandomYellowAgent) else 'red'
